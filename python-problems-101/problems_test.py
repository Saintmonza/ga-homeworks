...
class ProblemsTest(unittest.TestCase):
    ...
    def test_order_string_alphabetically(self):
        self.assertEqual(
            problems.order_string_alphabetically("happy"), "ahppy")
        self.assertEqual(problems.order_string_alphabetically(
            "python is cool"), "chilnooopsty")
        self.assertEqual(problems.order_string_alphabetically(
            "Testing Rocks"), "cegiknorsstt")
